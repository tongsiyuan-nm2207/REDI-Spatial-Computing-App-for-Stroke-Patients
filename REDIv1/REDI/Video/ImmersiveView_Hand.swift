...
@Observable
class TappedComponent: Component {
...
struct HandImmersiveView: View {
    ...
    var body: some View {
        RealityView { content, attachments in
            ...
            Task {
                do {
                    ...
                    loadedCube.components.set(TappedComponent())
            ...
            guard let component = cube.components[TappedComponent.self] else { return }
            ...
            Attachment(id: "gameUI") {
                if let cube = cubeEntity,
                   let component = cube.components[TappedComponent.self] {
        ...
        .gesture(
            ...
            SpatialTapGesture()
                .targetedToAnyEntity()
                .onEnded { value in
                    if let component = value.entity.components[TappedComponent.self],
    ...
    private func handleSuccess(for entity: Entity, method: String) {
        guard let component = entity.components[TappedComponent.self],
