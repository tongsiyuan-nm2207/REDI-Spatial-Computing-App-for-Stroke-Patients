...
struct TwoHandCardView: View {
    ...
    var options: [(String, String)] {
        ...
        default: // case 3 and beyond
            return [
                ("Safe to cross", "Lift your left arm"),
    ...
    let rightCards = ["Safe to cross"]
    
    // Final cards that trigger navigation
    let finalCards = ["Safe to cross", "61"]
...
#Preview {
    TwoHandCardView(clickCount: .constant(0), marks: .constant(0), showingResults: .constant(false))
}
